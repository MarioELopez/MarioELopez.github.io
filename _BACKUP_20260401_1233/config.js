...
const CONFIG = {
  ...
  modos: {
    ...
    casual: {
      ...
      descripcion: null,
      badge:       null,
      actualmente: "Buscando un club para rodar los fines de semana 🚴",
      ordenLinks:  [
        "_social",
  ...
  streakActivo: true,               // Cambiar a false si rompés la racha para ocultar el contador
  ...
  // ── ÚLTIMA ACTUALIZACIÓN (fallback local) ───────────────
  //  GitHub Actions sobreescribe esto automáticamente vía meta.json.
  //  Actualiza esta fecha manualmente solo si no usás el script de sync.
  lastUpdated: "2026-03-31",

  // ── ANIMACIÓN DEL AVATAR ─────────────────────────────────
  //  Velocidad del blob morfológico. Más alto = más lento y suave.
  //  Valores sugeridos: "4s" (rápido), "6s" (medio), "10s" (muy lento)
  avatarBlobDuration: "6s",
